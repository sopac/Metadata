...
rootPath = "/run/media/sachin/VERBATIMHD1/GISNOV2012/DATA/GIS - Geographical Information Systems/"
output = ""
...
def processResults(res, path):
    ...
    print "----------------------------------------------------"
    #write to file
    f = open("/home/sachin/gisdata.csv", "w")
    f.write(output)
